...
| One meeting in two calendars | a meeting cross-invited to both tenants | listed **once**, matched on `ical_uid` and failing that on `meeting_id` | N/A |
