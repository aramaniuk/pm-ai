...
- source_spec: `_bmad-output/planning-artifacts/architecture/architecture-pm-ai-2026-08-18/ARCHITECTURE-SPINE.md` (AD-11)
  summary: `entry._ambiguous` tells the operator "pm-ai has no way to choose between them yet" and its docstring calls the working directory an option "not this module's policy to invent" — but AD-11 already chose it.
